    ...
    angular.module('ngFader', [])
        .directive('ngFader', function ($interval) {
            ...
            function link(scope) {
                ...
                scope.images = [
                    {alt: 'Slide1', src: './images/photos/36.jpg'},
                    {alt: 'Slide2', src: './images/photos/38.jpg'}
                ];
            ...
            return {
                ...
                '<ul>' +
                '<li ng-repeat="image in images" ng-swipe-right="sliderBack()" ng-swipe-left="sliderForward()"><img data-ng-src="{{image.src}}" data-ng-alt="{{image.alt}}" ng-class="show($index)"/></li>' +
                '</ul>',
